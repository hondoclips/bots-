...
async function sendHYPE() {
  try {
    ...
    await fetch('https://discord.com/api/webhooks/1484347301207212184/KKSqLoP79eKWouGMQRVphUxZwMUQ96psaQAs7IiFdrwIBvXZ4SVzRWtCivh0DHpXv6bl', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ embeds: [{ image: { url: chartUrl }, color: 0x0E0E0E }] })
    });

    console.log(`✅ HYPE sent: $${price.toFixed(2)}`);
  } catch (error) {
